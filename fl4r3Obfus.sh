...
# flareObfus is a (shiny and very hack-ish) PowerShell obfuscation script
...
# usage: ./flareObfus.sh -f shells/Invoke-PowerShellTcp.ps1 -l 4 -v -t -c -i -p -s ascii,get-location,getstream -b invoke-expression,new-object,reverse,powershell -j -g -r -h -o /tmp/chimera.ps1
...
# all of the flareObfus functions, in preferred order
